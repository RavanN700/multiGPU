...
int main(int argc, char **argv) {
    ...
    printf("Output vector V_A[memsize-1] (original value = 1): %d\n", h_A[memsize-1]);
    printf("Output vector V_B[memsize-1] (original value = 2): %d\n", h_B[memsize-1]);
    // printf("Output vector V_C[memsize-1] (original value = 3): %d\n", h_C[memsize-1]);
